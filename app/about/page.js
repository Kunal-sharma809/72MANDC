...
const page = () => {
    return (
        <div>
            ...
            <div className="about bg-gradient-to-b from-[#fcf7ea] to-[#fff] py-22 px-14 flex flex-col items-center justify-center gap-34 mx-auto">
                <div className="container flex justify-between w-[85vw] mx-auto max-xl:flex-col max-xl:gap-8 max-xl:items-center">
            ...
            <div className="flex flex-col gap-12 bg-[#f0ebdc] shadow-xl w-[90vw] rounded-lg p-12 mx-auto">
                <div className="container flex justify-between items-center max-xl:flex-col max-xl:justify-center max-xl:mx-auto max-xl:w-[80vw] max-xl:items-center max-xl:gap-5">
