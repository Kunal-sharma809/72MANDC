...
const page = () => {
    return (
        <>
            ...
            <div className="about w-full bg-gradient-to-b from-[#fcf7ea] to-[#fff] py-22 px-14 flex flex-col items-center justify-center gap-34">
                <div className="projects flex justify-between w-[85vw] max-xl:flex-col max-xl:gap-8 max-xl:items-center">
                    <div className="content flex jsutify-center items-center gap-5 flex-col w-[40vw] max-xl:w-[85vw]">
                        ...
                        <h1 className="font-[800] text-4xl bg-gradient-to-r from-[#407050] via-[#76702c] to-[#b99d4ab0] text-transparent bg-clip-text inline-block">Our Completed Projects</h1>
                        <p className='text-center mt-3'>Spanning over 18 locations, BGR has successfully completed 50 projects both locally and internationally with utmost efficiency, environmental care and significant employment contribution to the society.</p>
            ...
            <div className="technology flex flex-col jsutify-center items-center w-[90vw] mx-auto mt-12 mb-34 bg-[#ece5cd] py-16 px-16">
                <div className="flex jsutify-center items-center gap-3 flex-col w-[90vw] mx-auto">
                    <h3 className="font-semibold text-xl">World class</h3>
                    <h1 className="font-[800] text-4xl bg-gradient-to-r from-[#407050] via-[#76702c] to-[#b99d4ab0] text-transparent bg-clip-text inline-block">Fleet & Technology</h1>
                </div>
                <div className="flex w-full justify-between mt-22 items-center max-xl:flex-col max-xl:gap-8">
                    ...
                    <div className="w-[40vw] max-xl:w-[70vw]">
                        <p className="max-xl:text-center">
                            BGR continues to pioneer technical advances in mining. Global positioning satellites, real-time monitoring systems and computerized dispatching technologies improve operating efficiency by working hand in hand with skilled manpower. Our maintenance reliability program uses sophisticated analytics to enhance operator safety and equipment availability.
